...
// import {subUnitDivisors, currencyFormatting} from '@config/settingsCurrency';
...
const appSettings = {
  ...
  sdk: {
    ...
    assetCdnBaseUrl: ENV.SDK_ASSET_CDN_BASE_URL,
    transitVerbose: ENV.SHARETRIBE_SDK_TRANSIT_VERBOSE === 'true',
  },
  ...
  usingSSL: ENV.SHARETRIBE_USING_SSL === 'true',
};
